...
## 파일명
- 모델 학습: onlyscript.ipynb
- 모델 사용: classification.ipynb
- 학습 데이터셋: Dataset
- 테스트셋: Test
...
## 5. 연령 분류 
- 랜덤서치로 분류 최적화 k, 기준 설정 
- 공격성 비율이 9%이상인 것을 19세, 3.5%이상을 15세, 나머지를 ALL로 분류 
...
공격성 퍼센트에 따라 '이 콘텐츠는 {}%의 공격성을 포함하고 있습니다.' 문구를 포함한 영상을 생성하고자 함
로컬에서 실행 시 RAM 부족으로 영상이 추출되지 않음.
